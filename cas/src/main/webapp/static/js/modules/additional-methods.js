 ...
 /*    $.validator.addMethod("regex_group", function(value, element) {
     ...
     $.validator.addMethod("email", function(email, element) {
         ...
         return this.optional(element) || email.match(/^(\w)+(\.\w+)*@(\w)+((\.\w+)+)$/);
     ...
     }, "New password must contain at least 8 characters, including upper case letter, lower case letter, numbers and special characters.");

	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-12 col-sm-12" id="real-time-panel">
				<div class="g-panel">
					<div class="g-panel-title clearfix">
						<span class="g-panel-text">Real - Time Status</span> <span
							class="g-panel-detail realTime-dashaboard-time dashaboard-time">
						</span>
					...
					<div class="g-panel-body">
						<div class="row dashboard-row realTime-dashboard-row "></div>
					</div>
				</div>
			</div>
			<!-- terminal-usage-->
			...
			<div class="col-md-12 col-sm-12" id="usage-panel" style="display: none">
				<div class="g-panel">
					<div class="g-panel-title clearfix">
						<span class="g-panel-text">Usage Data</span> <span
							class="g-panel-detail usage-dashaboard-time dashaboard-time">
							(Calculated By Server Time)
						</span>
					...
					<div class="g-panel-body">
						<div class="row usage-dashboard-row dashboard-row"></div>
					</div>
				</div>
			</div>
			-->

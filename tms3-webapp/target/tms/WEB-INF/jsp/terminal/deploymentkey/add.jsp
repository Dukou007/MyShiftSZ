					...
					<div class="col-sm-12 col-md-5">
						<div class="g-panel">
							 <div class="g-panel-title clearfix">
								<span class="g-panel-text">Deploy Key</span>
							</div> 
									...
									<div class="col-md-12">
										...
										<form class="form-horizontal" id="add-template" role="form" autocomplete="off">
											...
											<div class="form-edit-group col-md-12">
												<div class="edit-name">Key Name</div>
												<div class="edit-value">
													<c:forEach items="${keyList}" var="item" end='0'>
														<c:out value="${item.name}" />
														<input type="hidden"  value="${item.name}" name="keyName">
													</c:forEach>
												</div>
											</div>
											<div class="form-edit-group col-md-12">
												<div class="edit-name">Key Version<span class="icon-required">*</span></div>
												<div class="edit-value">
													<select class="form-control required" name='pkgId' id='first-packageversion'>
...
<!-- footer -->
<script type="text/javascript">seajs.use('add-terminal-deploy-key');</script>

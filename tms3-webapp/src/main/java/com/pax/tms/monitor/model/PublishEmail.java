...
@Entity
@Table(name = "TMSTALERT_PUBLISH_EMAIL")
public class PublishEmail extends AbstractModel {

	private static final long serialVersionUID = -8796811285859038985L;
	public static final String ID_SEQUENCE_NAME = "TMSTALERT_PUBLISH_EMAIL_ID";

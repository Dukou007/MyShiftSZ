            ...
            <div class="col-sm-12 col-md-12">
                <div class="g-panel clearfix">
                    <div class="g-panel-text ">
                       <!--  <a class="g-back-button iconfont" href="javascript:history.go(-1)"></a> -->Import Terminals
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="modal_terminal_import" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="confirm_import_terminal">Confirm</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<div class="modal fade" id="modal_terminal_delete" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" id="confirm_delete_terminal">Confirm</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<!-- modal -->
<!--modal import geoup again-->
<div class="modal fade" id="modal_terminal_reconfirm" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>

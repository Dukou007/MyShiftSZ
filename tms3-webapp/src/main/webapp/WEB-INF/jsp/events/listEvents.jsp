				...
				<div class="g-panel">
					<div class="g-panel-title text-right clearfix"
						...
						<div class="text-left">
							...
							<ul class="nav nav-pills mb10 block-inline" role="tablist"
								id="eventTab">
								<li role="presentation" class="active" data-type="All"><a>All</a>
								</li>
								<li role="presentation" data-type="Group"><a>Group</a></li>
								<li role="presentation" data-type="Terminal"><a>Terminal</a>
								</li>
							</ul>

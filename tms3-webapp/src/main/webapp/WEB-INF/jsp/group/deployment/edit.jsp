...
<div class="g-middle-content">
	...
	<input type="hidden"  id="inherited" value="${inherited}">
		<form class="form-horizontal" id="edit-group-deploy" role="form">
								...
								<div class="col-md-8">
									<div class="row">
										...
										<div class="view-item col-md-6">
											...
											<div class="view-value">
												 <c:out value="${deploy.pkg.name}" escapeXml="true" />
											</div>
										</div>
										<div class="view-item col-md-6">
											<div class="view-name">
											...
											<div class="view-value">
												 <c:out value="${deploy.pkg.version}" escapeXml="true" />
											</div>
										</div>
										<div class="form-edit-group edit-item-panel col-md-6 hide">
											<div class="edit-name">
												Download Time
												<span class="icon-required">*</span>
											</div>
											<div class="edit-value">
												<input type="text" class="form-control required form_datetime g-timeselect" placeholder=" " readonly="readonly" name="dwnlStartTime" value="<fmt:formatDate value="${deploy.dwnlStartTime}" pattern="yyyy-MM-dd HH:mm:ss" />" id='dwnlstarttime'></div>
										</div>
										...
										<div class="form-edit-group edit-item-panel col-md-6 hide" >
											...
											<div class="edit-value">
												<input type="text" class="form-control required form_datetime g-timeselect" placeholder=" " readonly="readonly" name="actvStartTime" value="<fmt:formatDate value="${deploy.actvStartTime}" pattern="yyyy-MM-dd HH:mm:ss" />" id='first-templatename'></div>
										</div>
										<div class="view-item view-item-panel col-md-6" >
											<div class="view-name">
												Activation Time
...
<!-- footer -->
<script type="text/javascript">seajs.use('view-group-deploy');</script>

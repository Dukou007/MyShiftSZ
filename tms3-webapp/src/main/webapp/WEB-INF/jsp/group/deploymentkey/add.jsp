				...
				<div class="col-sm-12 col-md-5">
					<div class="g-panel">
						...
						<div class="g-panel-body">
							<div class="row">
									<form class="form-horizontal" id="add-group-deploy-key" role="form" autocomplete="off">
										...
										<div class="form-edit-group col-md-12">
											...
											<div class="edit-value">
												<select class="form-control required first-packageversion" name='keyversion'>
													<option value=0 selected>Lastest Upload Version</option>
													<option value=1>Highest Version</option>
												</select>
											</div>
										</div>
										<div class="form-edit-group col-md-12">
			...
			<div class="modal-body">
				<div class="confirm-modal-body">
					...
					<div class="view-item ">
						...
						<div class="view-value" id="confirm-keyname" style=" ">
							
						</div>
					</div>
					<div class="view-item ">
						<div class="view-name" >Key Version</div>
						<div class="view-value" id="confirm-keyversion" style=" ">
					...
					<div class="view-item">
						<div class="view-name" >Ineligible Terminal Number</div>
						<div class="view-value" id="confirm-ineligibelSn" style=" ">
...
<!-- footer -->
<script type="text/javascript">seajs.use('add-group-deploy-key');</script>

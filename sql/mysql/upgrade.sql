...
-- ----------------------------------------------------------------------- --
-- upgrade from version V1.00.05 to version V1.00.06, datatime:            --
-- ----------------------------------------------------------------------- --
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE)
...
ADD COLUMN `INSTALL_APPS` VARCHAR(2000) NULL COMMENT 'install apps' AFTER `DESCRIPTION`;
...
ALTER TABLE TMSTTERMINAL
ADD COLUMN REPORT_TIME datetime after INSTALL_APPS;

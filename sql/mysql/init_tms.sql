...
-- province --
insert into PUBTSEQUENCE (SEQ_NAME,NEXT_VALUE) values ('PUBTPROVINCE_ID', 170);
...
(1, '1', 'Entities','0', null, '1', 'Entities', 0, 'system', now(), 'system',now());
...
(1, 'Site Administrator', 'Site Administrator', 'TMS', '1', 'system', now(), 'system', now());
insert into  PUBTROLE (ROLE_ID,ROLE_NAME,ROLE_DESC,APP_NAME,IS_SYS,CREATOR,CREATE_DATE,MODIFIER,MODIFY_DATE) values 
(2, 'Administrator', 'Administrator', 'TMS', '1', 'system', now(), 'system', now());
insert into  PUBTROLE (ROLE_ID,ROLE_NAME,ROLE_DESC,APP_NAME,IS_SYS,CREATOR,CREATE_DATE,MODIFIER,MODIFY_DATE) values 
(3, 'Supervisor', 'Supervisor', 'TMS','1', 'system', now(), 'system', now());
insert into  PUBTROLE (ROLE_ID,ROLE_NAME,ROLE_DESC,APP_NAME,IS_SYS,CREATOR,CREATE_DATE,MODIFIER,MODIFY_DATE) values 
(4, 'Operator', 'Operator', 'TMS', '1', 'system', now(), 'system', now());
insert into  PUBTROLE (ROLE_ID,ROLE_NAME,ROLE_DESC,APP_NAME,IS_SYS,CREATOR,CREATE_DATE,MODIFIER,MODIFY_DATE) values 
(5, 'Installer', 'Installer', 'TMS', '1','system', now(), 'system', now());

insert into  PUBTROLE(ROLE_ID,ROLE_NAME,ROLE_DESC,APP_NAME,IS_SYS,CREATOR,CREATE_DATE,MODIFIER,MODIFY_DATE) values 
(6, 'Administrator','role_Administrator','PxDesigner', '1','system',now(),'system',now());
insert into  PUBTROLE(ROLE_ID,ROLE_NAME,ROLE_DESC,APP_NAME,IS_SYS,CREATOR,CREATE_DATE,MODIFIER,MODIFY_DATE) values
(7, 'Developer','role_Developer','PxDesigner', '1','system',now(),'system',now());
insert into  PUBTROLE(ROLE_ID,ROLE_NAME,ROLE_DESC,APP_NAME,IS_SYS,CREATOR,CREATE_DATE,MODIFIER,MODIFY_DATE) values
(8, 'Deployer', 'role_Deployer','PxDesigner', '1','system',now(),'system',now());
insert into  PUBTROLE(ROLE_ID,ROLE_NAME,ROLE_DESC,APP_NAME,IS_SYS,CREATOR,CREATE_DATE,MODIFIER,MODIFY_DATE) values
(9, 'Signer','role_Signer','PxDesigner','1','system',now(),'system',now());
...
'25389240a6e1605d095a87b7e7e3bd7c','SHA-512','691',now(),'0','0','0',
'Offline:1,Tampers:1,SRED:1,Downloads:1,Activations:1,Privacy Shield:1,Stylus:0,RKI:0',
...
'e95b1c844a2c535122d99112b4bdc0f5','SHA-512','332',now(),'0','0','0',
'Offline:1,Tampers:1,SRED:1,Downloads:1,Activations:1,Privacy Shield:1,Stylus:0,RKI:0',
'Download History:1,Activation History:1,MSR Read:1,Contact IC Read:1,PIN Encryption Failure:1,Signature:1,Contactless IC Read:1,Transactions:1,Power-cycles:1',
'system',now(),'system',now());
...
-- mfr --
INSERT INTO TMSTMFR VALUES ('1', 'pax', 'pax', 'system', now(), 'system', now());

-- model  --
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('D210', 'D210', '1', null, 'D210', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('D220', 'D220', '1', null, 'D220', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('D210s', 'D210s', '1', null, 'D210s', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('MT30', 'MT30', '1', null, 'MT30', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('MT30s', 'MT30s', '1', null, 'MT30s', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('Px5', 'Px5', '1', null, 'Px5', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('Px7', 'Px7', '1', null, 'Px7', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('PX7L', 'PX7L', '1', null, 'PX7L', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('S300', 'S300', '1', null, 'S300', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('S58', 'S58', '1', null, 'S58', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('S80', 'S80', '1', null, 'S80', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('S90', 'S90', '1', null, 'S90', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('S920', 'S920', '1', null, 'S920', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('SP20', 'SP20', '1', null, 'SP20', 'system', now(), 'system', now());
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('SP30', 'SP30', '1', null, 'SP30', 'system', now(), 'system', now());
-- Q30 --
INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE) 
VALUES ('Q30', 'Q30', '1', null, 'Q30', 'system', now(), 'system', now());

INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE)
VALUES ('Px7A', 'Px7A', '1', null, 'Px7A', 'system', now(), 'system', now());

INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE)
VALUES ('A920', 'A920', '1', null, 'A920', 'system', now(), 'system', now());

INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE)
VALUES ('Aries8', 'Aries8', '1', null, 'Aries8', 'system', now(), 'system', now());

INSERT INTO TMSTMODEL (MODEL_ID, MODEL_NAME, MFR_ID, PLATFORM, MODEL_DESC, CREATOR, CREATE_DATE, MODIFIER, MODIFY_DATE)
VALUES ('A60', 'A60', '1', null, 'A60', 'system', now(), 'system', now());
